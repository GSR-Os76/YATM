...
public class SolarPanelBlock extends DeviceBlock
{
	...
	public SolarPanelBlock(Properties properties, VoxelShapeProvider shape, int currentCapacity, int maxSafeCurrent, int maxCurrent, SolarPanelSettings settings)
	{
