...
public class FlammableStairBlock extends StairBlock
{
	...
	public FlammableStairBlock(Supplier<BlockState> state, Properties properties, int flammability, int fireSpreadSpeed)
	{
		super(state, Objects.requireNonNull(properties));
