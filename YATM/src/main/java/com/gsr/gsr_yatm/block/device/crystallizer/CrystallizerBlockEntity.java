...
public class CrystallizerBlockEntity extends CraftingDeviceBlockEntity<CrystallizingRecipe, Container>
{
	...
	private final @NotNull FillTankManager m_fillInputTankManager = new FillTankManager(this.m_inventory, CrystallizerBlockEntity.FILL_INPUT_TANK_SLOT, this.m_inputTank, YATMConfigs.CRYSTALLIZER_FILL_MAX_FLUID_TRANSFER_RATE.get());
