...
public class CurrentDrainManager implements ITickableBehavior
{
	@Override
	...
	public CurrentDrainManager(@NotNull IItemHandler inventory, @NotNegative int slot, @NotNull ICurrentHandler currentHandler, @NotNegative int maxTransfer) 
	{
