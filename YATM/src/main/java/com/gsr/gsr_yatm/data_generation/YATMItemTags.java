...
//		this.tag(YATMItemTags.FORGE_SILVER_NUGGETS_KEY).add(YATMItems.SILVER_NUGGET.get());
		...
		this.tag(YATMItemTags.DRILLS_KEY).add(YATMItems.STEEL_DRILL_STEEL.get()).add(YATMItems.STEEL_DRILL_NETHERITE.get());
		...
		this.tag(YATMItemTags.SAWS_KEY).add(YATMItems.STEEL_SAW_STEEL.get()).add(YATMItems.STEEL_SAW_NETHERITE.get());
