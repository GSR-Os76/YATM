...
public class YATMRecipeProvider extends RecipeProvider
{
	...
	private void addCraftingRecipes(@NotNull RecipeOutput output) 
	{
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, YATMItems.CU_TO_FE_CONVERTER.get(), 1).pattern("rgv").pattern("ggg").pattern("vgr").define('g', Items.GOLD_INGOT).define('r', Items.REDSTONE).define('v', YATMItems.CONDUIT_VINES.get()).unlockedBy("has_item", has(YATMItems.CONDUIT_VINES.get())).save(output, YetAnotherTechMod.MODID + ":cu_to_fe_converter_from_shaped_crafting");
		// TODO, this next line is seemingly without purpose, as both patterns produce a Cu to Fe converter. make sure this is fixed in final grafting recipe.
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, YATMItems.FE_TO_CU_CONVERTER.get(), 1).pattern("vgr").pattern("ggg").pattern("rgv").define('g', Items.GOLD_INGOT).define('r', Items.REDSTONE).define('v', YATMItems.CONDUIT_VINES.get()).unlockedBy("has_item", has(YATMItems.CONDUIT_VINES.get())).save(output, YetAnotherTechMod.MODID + ":fe_to_cu_converter_from_shaped_crafting");
		this.addOneToX(output, YATMItems.CU_TO_FE_CONVERTER.get(), YATMItems.FE_TO_CU_CONVERTER.get(), 1, YetAnotherTechMod.MODID + ":fe_to_cu_converter_from_cu_to_fe_converter_from_shapeless_crafting");
...
//		this.addPartExchange(output, YATMItemTags.SAWS_KEY, new ItemStack(YATMItems.DIAMOND_SAW_BLADE.get()), new ItemStack(YATMItems.STEEL_SAW_DIAMOND.get()), "saw_blade_adjustment", YetAnotherTechMod.MODID + ":steel_saw_diamond_from_part_exchange");
	...
	{
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, YATMItems.BIOREACTOR.get(), 1).pattern("fff").pattern("mkm").pattern("ftf").define('f', YATMItems.FOLIAR_STEEL.get()).define('k', YATMItems.KINETIC_DRIVER.get()).define('m', Tags.Items.MUSHROOMS).define('t', YATMItems.CURRENT_TUBER.get()).unlockedBy("has_item", has(YATMItems.FOLIAR_STEEL.get())).save(output, YetAnotherTechMod.MODID + ":bioreactor_from_shaped_crafting");
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, YATMItems.CRUCIBLE.get(), 1).pattern("fff").pattern("b b").pattern("fgf").define('b', YATMItemTags.FORGE_BRICKS_NETHER).define('f', YATMItems.FOLIAR_STEEL.get()).define('g', YATMItems.RAW_EXOTHERMIC_GLAND.get()).unlockedBy("has_item", has(YATMItems.FOLIAR_STEEL.get())).save(output, YetAnotherTechMod.MODID + ":crucible_from_shaped_crafting");
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, YATMItems.CRYSTALLIZER.get(), 1).pattern("fff").pattern("glg").pattern("ftf").define('f', YATMItems.FOLIAR_STEEL.get()).define('g', Tags.Items.GLASS).define('l', Items.LIGHTNING_ROD).define('t', YATMItems.CURRENT_TUBER.get()).unlockedBy("has_item", has(YATMItems.FOLIAR_STEEL.get())).save(output, YetAnotherTechMod.MODID + ":crystallizer_from_shaped_crafting");
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, YATMItems.HEAT_FURNACE.get(), 1).pattern("fff").pattern("f f").pattern("fgf").define('f', YATMItems.FOLIAR_STEEL.get()).define('g', YATMItems.RAW_EXOTHERMIC_GLAND.get()).unlockedBy("has_item", has(YATMItems.FOLIAR_STEEL.get())).save(output, YetAnotherTechMod.MODID + ":heat_furnace_from_shaped_crafting");
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, YATMItems.EXTRACTOR.get(), 1).pattern("fff").pattern("p p").pattern("ftf").define('f', YATMItems.FOLIAR_STEEL.get()).define('p', YATMItemTags.FORGE_PISTONS_KEY).define('t', YATMItems.CURRENT_TUBER.get()).unlockedBy("has_item", has(YATMItems.FOLIAR_STEEL.get())).save(output, YetAnotherTechMod.MODID + ":extractor_from_shaped_crafting");
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, YATMItems.GRINDER.get(), 1).pattern("fff").pattern("kFk").pattern("ftf").define('f', YATMItems.FOLIAR_STEEL.get()).define('F', Items.FLINT).define('k', YATMItems.KINETIC_DRIVER.get()).define('t', YATMItems.CURRENT_TUBER.get()).unlockedBy("has_item", has(YATMItems.FOLIAR_STEEL.get())).save(output, YetAnotherTechMod.MODID + ":grinder_from_shaped_crafting");
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, YATMItems.INJECTOR.get(), 1).pattern("fff").pattern("pkp").pattern("ftf").define('f', YATMItems.FOLIAR_STEEL.get()).define('k', YATMItems.KINETIC_DRIVER.get()).define('p', YATMItems.CHANNEL_VINES.get()).define('t', YATMItems.CURRENT_TUBER.get()).unlockedBy("has_item", has(YATMItems.FOLIAR_STEEL.get())).save(output, YetAnotherTechMod.MODID + ":injector_from_shaped_crafting");
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, YATMItems.STILL.get(), 1).pattern("fff").pattern("pip").pattern("fbf").define('b', YATMItems.BOILER.get()).define('f', YATMItems.FOLIAR_STEEL.get()).define('i', YATMItemTags.FORGE_ICE).define('p', YATMItems.CHANNEL_VINES.get()).unlockedBy("has_item", has(YATMItems.FOLIAR_STEEL.get())).save(output, YetAnotherTechMod.MODID + ":still_from_shaped_crafting");
