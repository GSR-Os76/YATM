...
public class YATMBlockTags extends BlockTagsProvider
{
	...
	public static final TagKey<Block> CRYING_FLOWER_CAN_GROW_IN_KEY = TM.createTagKey(new ResourceLocation(YetAnotherTechMod.MODID, "mediums/crying_flower_can_grow_in"));
	public static final TagKey<Block> CRYING_FLOWER_CAN_GROW_ON_KEY = TM.createTagKey(new ResourceLocation(YetAnotherTechMod.MODID, "mediums/crying_flower_can_grow_on"));
	public static final TagKey<Block> CRYING_PLANT_VEGETATION_KEY = TM.createTagKey(new ResourceLocation(YetAnotherTechMod.MODID, "mediums/crying_plant_vegetation"));
	public static final TagKey<Block> CRYING_PLANT_CAN_GROW_IN_KEY = TM.createTagKey(new ResourceLocation(YetAnotherTechMod.MODID, "mediums/crying_plant_can_grow_in"));
	public static final TagKey<Block> CRYING_PLANT_CAN_GROW_ON_KEY = TM.createTagKey(new ResourceLocation(YetAnotherTechMod.MODID, "mediums/crying_plant_can_grow_on"));
	...
	protected void addTags(Provider provider)
	{
		...
		this.tag(BlockTags.MINEABLE_WITH_AXE).add(YATMBlocks.GRAFTING_TABLE.get()).addTag(YATMBlockTags.SAP_COLLECTORS_KEY).add(YATMBlocks.SPINNING_WHEEL.get()).add(YATMBlocks.CURRENT_TUBER_BLOCK.get());
		...
		this.tag(YATMBlockTags.CONDUIT_NEUTRAL_ONLY_ATTACHMENT_KEY).add(YATMBlocks.CONDUIT_VINE_BUNDLE.get());
		this.tag(YATMBlockTags.CONDUIT_VINES_CAN_GROW_IN_KEY).add(Blocks.AIR);
