...
public class SpeedUpgradeItem extends Item implements ISpeedUpgradeItem
{
	...
	public SpeedUpgradeItem(@NotNull Properties properties, float bonus, @NotNull BonusType type)
	{
