...
import com.gsr.gsr_yatm.fluid.SilconOxideFluidType;
...
public class YATMFluidTypes
{
	...
	public static final RegistryObject<SilconOxideFluidType> SILICON_OXIDE = FLUID_TYPES.register("silicon_oxide", () -> new SilconOxideFluidType(Properties.create().viscosity((int)(24000)).pathType(BlockPathTypes.LAVA).density(2).temperature(1986).canDrown(false)));
