...
public class YATMItems
{
	...
	public static final RegistryObject<BlockItem> RUBBER_LOG_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("rubber_log", () -> new BlockItem(YATMBlocks.RUBBER_LOG.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> RUBBER_WOOD_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("rubber_wood", () -> new BlockItem(YATMBlocks.RUBBER_WOOD.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> PARTIALLY_STRIPPED_RUBBER_LOG_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("partially_stripped_rubber_log", () -> new BlockItem(YATMBlocks.PARTIALLY_STRIPPED_RUBBER_LOG.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> STRIPPED_RUBBER_LOG_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("stripped_rubber_log", () -> new BlockItem(YATMBlocks.STRIPPED_RUBBER_LOG.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> STRIPPED_RUBBER_WOOD_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("stripped_rubber_wood", () -> new BlockItem(YATMBlocks.STRIPPED_RUBBER_WOOD.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> RUBBER_PLANKS_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("rubber_planks", () -> new BlockItem(YATMBlocks.RUBBER_PLANKS.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> FANCY_RUBBER_PLANKS_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("fancy_rubber_planks", () -> new BlockItem(YATMBlocks.FANCY_RUBBER_PLANKS.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> RUBBER_STAIRS_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("rubber_stairs", () -> new BlockItem(YATMBlocks.RUBBER_STAIRS.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> RUBBER_SLAB_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("rubber_slab", () -> new BlockItem(YATMBlocks.RUBBER_SLAB.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> RUBBER_FENCE_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("rubber_fence", () -> new BlockItem(YATMBlocks.RUBBER_FENCE.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> RUBBER_FENCE_GATE_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("rubber_fence_gate", () -> new BlockItem(YATMBlocks.RUBBER_FENCE_GATE.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> RUBBER_DOOR_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("rubber_door", () -> new BlockItem(YATMBlocks.RUBBER_DOOR.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> RUBBER_TRAPDOOR_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("rubber_trapdoor", () -> new BlockItem(YATMBlocks.RUBBER_TRAPDOOR.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> RUBBER_PRESSURE_PLATE_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("rubber_pressure_plate", () -> new BlockItem(YATMBlocks.RUBBER_PRESSURE_PLATE.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> RUBBER_BUTTON_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("rubber_button", () -> new BlockItem(YATMBlocks.RUBBER_BUTTON.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> LEAF_MULCH_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("leaf_mulch", () -> new BlockItem(YATMBlocks.LEAF_MULCH.get(), new Item.Properties()))));


	
	public static final RegistryObject<BlockItem> SOUL_AFFLICTED_RUBBER_LOG_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("soul_afflicted_rubber_log", () -> new BlockItem(YATMBlocks.SOUL_AFFLICTED_RUBBER_LOG.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> SOUL_AFFLICTED_RUBBER_WOOD_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("soul_afflicted_rubber_wood", () -> new BlockItem(YATMBlocks.SOUL_AFFLICTED_RUBBER_WOOD.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> SOUL_AFFLICTED_PARTIALLY_STRIPPED_RUBBER_LOG_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("soul_afflicted_partially_stripped_rubber_log", () -> new BlockItem(YATMBlocks.SOUL_AFFLICTED_PARTIALLY_STRIPPED_RUBBER_LOG.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> SOUL_AFFLICTED_STRIPPED_RUBBER_LOG_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("soul_afflicted_stripped_rubber_log", () -> new BlockItem(YATMBlocks.SOUL_AFFLICTED_STRIPPED_RUBBER_LOG.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> SOUL_AFFLICTED_STRIPPED_RUBBER_WOOD_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("soul_afflicted_stripped_rubber_wood", () -> new BlockItem(YATMBlocks.SOUL_AFFLICTED_STRIPPED_RUBBER_WOOD.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> SOUL_AFFLICTED_RUBBER_PLANKS_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("soul_afflicted_rubber_planks", () -> new BlockItem(YATMBlocks.SOUL_AFFLICTED_RUBBER_PLANKS.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> SOUL_AFFLICTED_FANCY_RUBBER_PLANKS_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("soul_afflicted_fancy_rubber_planks", () -> new BlockItem(YATMBlocks.SOUL_AFFLICTED_FANCY_RUBBER_PLANKS.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> SOUL_AFFLICTED_FANCY_RUBBER_PLANKS_TILED_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("soul_afflicted_fancy_rubber_planks_tiled", () -> new BlockItem(YATMBlocks.SOUL_AFFLICTED_FANCY_RUBBER_PLANKS_TILED.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> SOUL_AFFLICTED_RUBBER_STAIRS_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("soul_afflicted_rubber_stairs", () -> new BlockItem(YATMBlocks.SOUL_AFFLICTED_RUBBER_STAIRS.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> SOUL_AFFLICTED_RUBBER_SLAB_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("soul_afflicted_rubber_slab", () -> new BlockItem(YATMBlocks.SOUL_AFFLICTED_RUBBER_SLAB.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> SOUL_AFFLICTED_RUBBER_FENCE_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("soul_afflicted_rubber_fence", () -> new BlockItem(YATMBlocks.SOUL_AFFLICTED_RUBBER_FENCE.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> SOUL_AFFLICTED_RUBBER_FENCE_GATE_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("soul_afflicted_rubber_fence_gate", () -> new BlockItem(YATMBlocks.SOUL_AFFLICTED_RUBBER_FENCE_GATE.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> SOUL_AFFLICTED_RUBBER_DOOR_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("soul_afflicted_rubber_door", () -> new BlockItem(YATMBlocks.SOUL_AFFLICTED_RUBBER_DOOR.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> SOUL_AFFLICTED_RUBBER_TRAPDOOR_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("soul_afflicted_rubber_trapdoor", () -> new BlockItem(YATMBlocks.SOUL_AFFLICTED_RUBBER_TRAPDOOR.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> SOUL_AFFLICTED_RUBBER_PRESSURE_PLATE_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("soul_afflicted_rubber_pressure_plate", () -> new BlockItem(YATMBlocks.SOUL_AFFLICTED_RUBBER_PRESSURE_PLATE.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> SOUL_AFFLICTED_RUBBER_BUTTON_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("soul_afflicted_rubber_button", () -> new BlockItem(YATMBlocks.SOUL_AFFLICTED_RUBBER_BUTTON.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> SOUL_AFFLICTED_LEAF_MULCH_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("soul_afflicted_leaf_mulch", () -> new BlockItem(YATMBlocks.SOUL_AFFLICTED_LEAF_MULCH.get(), new Item.Properties()))));

	public static final RegistryObject<BlockItem> RUBBER_BLOCK_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("rubber_block", () -> new BlockItem(YATMBlocks.RUBBER_BLOCK.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> FOLIAR_STEEL_BLOCK_ITEM = buildingTabEnqueue(yatmGeTabEnqueue(ITEMS.register("foliar_steel_block", () -> new BlockItem(YATMBlocks.FOLIAR_STEEL_BLOCK.get(), new Item.Properties()))));
	
	public static final RegistryObject<BlockItem> CANDLE_LANTERN_ITEM = functionalTabEnqueue(colorTabEnqueue(yatmGeTabEnqueue(ITEMS.register("candle_lantern", () -> new BlockItem(YATMBlocks.CANDLE_LANTERN.get(), new Item.Properties())))));
	public static final RegistryObject<BlockItem> WHITE_CANDLE_LANTERN_ITEM = functionalTabEnqueue(colorTabEnqueue(yatmGeTabEnqueue(ITEMS.register("white_candle_lantern", () -> new BlockItem(YATMBlocks.WHITE_CANDLE_LANTERN.get(), new Item.Properties())))));
	public static final RegistryObject<BlockItem> LIGHT_GRAY_CANDLE_LANTERN_ITEM = functionalTabEnqueue(colorTabEnqueue(yatmGeTabEnqueue(ITEMS.register("light_gray_candle_lantern", () -> new BlockItem(YATMBlocks.LIGHT_GRAY_CANDLE_LANTERN.get(), new Item.Properties())))));
	public static final RegistryObject<BlockItem> GRAY_CANDLE_LANTERN_ITEM = functionalTabEnqueue(colorTabEnqueue(yatmGeTabEnqueue(ITEMS.register("gray_candle_lantern", () -> new BlockItem(YATMBlocks.GRAY_CANDLE_LANTERN.get(), new Item.Properties())))));
	public static final RegistryObject<BlockItem> BLACK_CANDLE_LANTERN_ITEM = functionalTabEnqueue(colorTabEnqueue(yatmGeTabEnqueue(ITEMS.register("black_candle_lantern", () -> new BlockItem(YATMBlocks.BLACK_CANDLE_LANTERN.get(), new Item.Properties())))));
	public static final RegistryObject<BlockItem> BROWN_CANDLE_LANTERN_ITEM = functionalTabEnqueue(colorTabEnqueue(yatmGeTabEnqueue(ITEMS.register("brown_candle_lantern", () -> new BlockItem(YATMBlocks.BROWN_CANDLE_LANTERN.get(), new Item.Properties())))));
	public static final RegistryObject<BlockItem> RED_CANDLE_LANTERN_ITEM = functionalTabEnqueue(colorTabEnqueue(yatmGeTabEnqueue(ITEMS.register("red_candle_lantern", () -> new BlockItem(YATMBlocks.RED_CANDLE_LANTERN.get(), new Item.Properties())))));
	public static final RegistryObject<BlockItem> ORANGE_CANDLE_LANTERN_ITEM = functionalTabEnqueue(colorTabEnqueue(yatmGeTabEnqueue(ITEMS.register("orange_candle_lantern", () -> new BlockItem(YATMBlocks.ORANGE_CANDLE_LANTERN.get(), new Item.Properties())))));
	public static final RegistryObject<BlockItem> YELLOW_CANDLE_LANTERN_ITEM = functionalTabEnqueue(colorTabEnqueue(yatmGeTabEnqueue(ITEMS.register("yellow_candle_lantern", () -> new BlockItem(YATMBlocks.YELLOW_CANDLE_LANTERN.get(), new Item.Properties())))));
	public static final RegistryObject<BlockItem> LIME_CANDLE_LANTERN_ITEM = functionalTabEnqueue(colorTabEnqueue(yatmGeTabEnqueue(ITEMS.register("lime_candle_lantern", () -> new BlockItem(YATMBlocks.LIME_CANDLE_LANTERN.get(), new Item.Properties())))));
	public static final RegistryObject<BlockItem> GREEN_CANDLE_LANTERN_ITEM = functionalTabEnqueue(colorTabEnqueue(yatmGeTabEnqueue(ITEMS.register("green_candle_lantern", () -> new BlockItem(YATMBlocks.GREEN_CANDLE_LANTERN.get(), new Item.Properties())))));
	public static final RegistryObject<BlockItem> CYAN_CANDLE_LANTERN_ITEM = functionalTabEnqueue(colorTabEnqueue(yatmGeTabEnqueue(ITEMS.register("cyan_candle_lantern", () -> new BlockItem(YATMBlocks.CYAN_CANDLE_LANTERN.get(), new Item.Properties())))));
	public static final RegistryObject<BlockItem> LIGHT_BLUE_CANDLE_LANTERN_ITEM = functionalTabEnqueue(colorTabEnqueue(yatmGeTabEnqueue(ITEMS.register("light_blue_candle_lantern", () -> new BlockItem(YATMBlocks.LIGHT_BLUE_CANDLE_LANTERN.get(), new Item.Properties())))));
	public static final RegistryObject<BlockItem> BLUE_CANDLE_LANTERN_ITEM = functionalTabEnqueue(colorTabEnqueue(yatmGeTabEnqueue(ITEMS.register("blue_candle_lantern", () -> new BlockItem(YATMBlocks.BLUE_CANDLE_LANTERN.get(), new Item.Properties())))));
	public static final RegistryObject<BlockItem> PURPLE_CANDLE_LANTERN_ITEM = functionalTabEnqueue(colorTabEnqueue(yatmGeTabEnqueue(ITEMS.register("purple_candle_lantern", () -> new BlockItem(YATMBlocks.PURPLE_CANDLE_LANTERN.get(), new Item.Properties())))));
	public static final RegistryObject<BlockItem> MAGENTA_CANDLE_LANTERN_ITEM = functionalTabEnqueue(colorTabEnqueue(yatmGeTabEnqueue(ITEMS.register("magenta_candle_lantern", () -> new BlockItem(YATMBlocks.MAGENTA_CANDLE_LANTERN.get(), new Item.Properties())))));
	public static final RegistryObject<BlockItem> PINK_CANDLE_LANTERN_ITEM = functionalTabEnqueue(colorTabEnqueue(yatmGeTabEnqueue(ITEMS.register("pink_candle_lantern", () -> new BlockItem(YATMBlocks.PINK_CANDLE_LANTERN.get(), new Item.Properties())))));
	
	public static final RegistryObject<BlockItem> FOLIAR_STEEL_ORE_ITEM = naturalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("foliar_steel_ore", () -> new BlockItem(YATMBlocks.FOLIAR_STEEL_ORE.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> DEEPSLATE_FOLIAR_STEEL_ORE_ITEM = naturalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("deepslate_foliar_steel_ore", () -> new BlockItem(YATMBlocks.DEEPSLATE_FOLIAR_STEEL_ORE.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> ROOTED_SOUL_SOIL_ITEM = naturalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("rooted_soul_soil", () -> new BlockItem(YATMBlocks.ROOTED_SOUL_SOIL.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> CARCASS_ROOT_ROOTED_DIRT_ITEM = naturalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("carcass_root_rooted_dirt", () -> new BlockItem(YATMBlocks.CARCASS_ROOT_ROOTED_DIRT.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> CARCASS_ROOT_ROOTED_NETHERRACK_ITEM = naturalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("carcass_root_rooted_netherrack", () -> new BlockItem(YATMBlocks.CARCASS_ROOT_ROOTED_NETHERRACK.get(), new Item.Properties()))));
	
	
	
	public static final RegistryObject<BlockItem> RUBBER_ROOTS_ITEM = naturalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("rubber_roots", () -> new BlockItem(YATMBlocks.RUBBER_ROOTS.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> SOUL_AFFLICTED_RUBBER_ROOTS_ITEM = naturalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("soul_afflicted_rubber_roots", () -> new BlockItem(YATMBlocks.SOUL_AFFLICTED_RUBBER_ROOTS.get(), new Item.Properties()))));
	
	public static final RegistryObject<BlockItem> RUBBER_LEAVES_YOUNG_ITEM = naturalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("rubber_leaves_young", () -> new BlockItem(YATMBlocks.RUBBER_LEAVES_YOUNG.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> RUBBER_LEAVES_FLOWERING_ITEM = naturalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("rubber_leaves_flowering", () -> new BlockItem(YATMBlocks.RUBBER_LEAVES_FLOWERING.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> RUBBER_LEAVES_OLD_ITEM = naturalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("rubber_leaves_old", () -> new BlockItem(YATMBlocks.RUBBER_LEAVES_OLD.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> SOUL_AFFLICTED_RUBBER_LEAVES_YOUNG_ITEM = naturalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("soul_afflicted_rubber_leaves_young", () -> new BlockItem(YATMBlocks.SOUL_AFFLICTED_RUBBER_LEAVES_YOUNG.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> SOUL_AFFLICTED_RUBBER_LEAVES_FLOWERING_ITEM = naturalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("soul_afflicted_rubber_leaves_flowering", () -> new BlockItem(YATMBlocks.SOUL_AFFLICTED_RUBBER_LEAVES_FLOWERING.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> SOUL_AFFLICTED_RUBBER_LEAVES_OLD_ITEM = naturalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("soul_afflicted_rubber_leaves_old", () -> new BlockItem(YATMBlocks.SOUL_AFFLICTED_RUBBER_LEAVES_OLD.get(), new Item.Properties()))));
	
	public static final RegistryObject<BlockItem> RUBBER_MERISTEM_ITEM = naturalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("rubber_meristem", () -> new BlockItem(YATMBlocks.RUBBER_MERISTEM.get(), new Item.Properties()))));	
	public static final RegistryObject<BlockItem> SOUL_AFFLICTED_RUBBER_MERISTEM_ITEM = naturalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("soul_afflicted_rubber_meristem", () -> new BlockItem(YATMBlocks.SOUL_AFFLICTED_RUBBER_MERISTEM.get(), new Item.Properties()))));
	...
	public static final RegistryObject<BlockItem> CANDLELILY_ITEM = naturalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("candlelily", () -> new BlockItem(YATMBlocks.CANDLELILY.get(), new Item.Properties()))));
	
	public static final RegistryObject<BlockItem> BLEACHED_ICE_CORAL_OLD_ITEM = naturalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("bleached_ice_coral_old", () -> new BlockItem(YATMBlocks.BLEACHED_ICE_CORAL_OLD.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> BLEACHED_ICE_CORAL_ADOLESCENT_ITEM = naturalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("bleached_ice_coral_adolescent", () -> new BlockItem(YATMBlocks.BLEACHED_ICE_CORAL_ADOLESCENT.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> BLEACHED_ICE_CORAL_YOUNG_ITEM = naturalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("bleached_ice_coral_young", () -> new BlockItem(YATMBlocks.BLEACHED_ICE_CORAL_YOUNG.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> BLEACHED_ICE_CORAL_POLYP_ITEM = naturalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("bleached_ice_coral_polyp", () -> new BlockItem(YATMBlocks.BLEACHED_ICE_CORAL_POLYP.get(), new Item.Properties()))));
	...
	public static final RegistryObject<BlockItem> PHANTASMAL_SHELF_FUNGUS_ITEM = naturalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("phantasmal_shelf_fungus", () -> new BlockItem(YATMBlocks.PHANTASMAL_SHELF_FUNGUS.get(), new Item.Properties()))));
	
	public static final RegistryObject<BlockItem> PITCHER_CLUSTER_ITEM = naturalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("pitcher_cluster", () -> new BlockItem(YATMBlocks.PITCHER_CLUSTER.get(), new Item.Properties()))));

	public static final RegistryObject<BlockItem> VARIEGATED_CACTUS_ITEM = naturalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("variegated_cactus", () -> new BlockItem(YATMBlocks.VARIEGATED_CACTUS.get(), new Item.Properties()))));
	...
	public static final RegistryObject<BlockItem> HANGING_POT_HOOK_ITEM = functionalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("hanging_pot_hook", () -> new BlockItem(YATMBlocks.HANGING_POT_HOOK.get(), new Item.Properties()))));
	
	public static final RegistryObject<BlockItem> GRAFTING_TABLE_ITEM = functionalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("grafting_table", () -> new BlockItem(YATMBlocks.GRAFTING_TABLE.get(), new Item.Properties()))));
	
	public static final RegistryObject<BlockItem> SAP_COLLECTOR_ITEM = functionalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("sap_collector", () -> new BlockItem(YATMBlocks.SAP_COLLECTOR.get(), new Item.Properties()))));
	// add celestial altar
	// add liquid celestial light, liquid lunar light, and the liquid solar liquids;
	public static final RegistryObject<BlockItem> SPINNING_WHEEL_ITEM = functionalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("spinning_wheel", () -> new BlockItem(YATMBlocks.SPINNING_WHEEL.get(), new Item.Properties()))));
	
	public static final RegistryObject<SignItem> RUBBER_SIGN_ITEM = functionalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("rubber_sign", () -> new SignItem(new Item.Properties().stacksTo(16), YATMBlocks.RUBBER_SIGN.get(), YATMBlocks.RUBBER_WALL_SIGN.get()))));
	public static final RegistryObject<HangingSignItem> RUBBER_HANGING_SIGN_ITEM = functionalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("rubber_hanging_sign", () -> new HangingSignItem(YATMBlocks.RUBBER_HANGING_SIGN.get(), YATMBlocks.RUBBER_WALL_HANGING_SIGN.get(), new Item.Properties().stacksTo(16)))));
	public static final RegistryObject<SignItem> SOUL_AFFLICTED_RUBBER_SIGN_ITEM = functionalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("soul_afflicted_rubber_sign", () -> new SignItem(new Item.Properties().stacksTo(16), YATMBlocks.SOUL_AFFLICTED_RUBBER_SIGN.get(), YATMBlocks.SOUL_AFFLICTED_RUBBER_WALL_SIGN.get()))));
	public static final RegistryObject<HangingSignItem> SOUL_AFFLICTED_RUBBER_HANGING_SIGN_ITEM = functionalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("soul_afflicted_rubber_hanging_sign", () -> new HangingSignItem(YATMBlocks.SOUL_AFFLICTED_RUBBER_HANGING_SIGN.get(), YATMBlocks.SOUL_AFFLICTED_RUBBER_WALL_HANGING_SIGN.get(), new Item.Properties().stacksTo(16)))));
	...
	public static final RegistryObject<BlockItem> STEEL_BIOLER_ITEM = functionalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("steel_bioler", () -> new BlockItem(YATMBlocks.STEEL_BIOREACTOR.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> STEEL_BOILER_ITEM = functionalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("steel_boiler", () -> new BlockItem(YATMBlocks.STEEL_BOILER.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> STEEL_CRUCIBLE_ITEM = functionalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("steel_crucible", () -> new BlockItem(YATMBlocks.STEEL_CRUCIBLE.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> STEEL_CRYSTALLIZER_ITEM = functionalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("steel_crystallizer", () -> new BlockItem(YATMBlocks.STEEL_CRYSTALLIZER.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> STEEL_CURRENT_FURNACE_ITEM = functionalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("steel_current_furnace", () -> new BlockItem(YATMBlocks.STEEL_CURRENT_FURNACE.get(), new Item.Properties()))));	
	public static final RegistryObject<BlockItem> STEEL_EXTRACTOR_ITEM = functionalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("steel_extractor", () -> new BlockItem(YATMBlocks.STEEL_EXTRACTOR.get(), new Item.Properties()))));
//	public static final RegistryObject<BlockItem> STEEL_EXTRUDER_ITEM = /* generalTabEnqueue */(ITEMS.register("steel_extruder", () -> new BlockItem(YATMBlocks.STEEL_EXTRUDER.get(), new Item.Properties())));
	public static final RegistryObject<BlockItem> STEEL_GRINDER_ITEM = functionalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("steel_grinder", () -> new BlockItem(YATMBlocks.STEEL_GRINDER.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> STEEL_INJECTOR_ITEM = functionalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("steel_injector", () -> new BlockItem(YATMBlocks.STEEL_INJECTOR.get(), new Item.Properties()))));

	public static final RegistryObject<BlockItem> STEEL_TANK_ITEM = functionalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("steel_tank", () -> new BlockItem(YATMBlocks.STEEL_TANK.get(), new Item.Properties()))));
	...
	// TODO, update item id, others as well
	public static final RegistryObject<ArmorItem> DECAY_NETHERITE_HELMET = combatTabEnqueue(yatmGeTabEnqueue(ITEMS.register("decaying_soul_adorned_netherite_helmet", () -> new ArmorItem(YATMArmorMaterials.DECAYING_SOUL_ADORNED_NETHERITE, ArmorItem.Type.HELMET, new Item.Properties().fireResistant()))));
	public static final RegistryObject<ArmorItem> DECAY_NETHERITE_CHESTPLATE = combatTabEnqueue(yatmGeTabEnqueue(ITEMS.register("decaying_soul_adorned_netherite_chestplate", () -> new ArmorItem(YATMArmorMaterials.DECAYING_SOUL_ADORNED_NETHERITE, ArmorItem.Type.CHESTPLATE, new Item.Properties().fireResistant()))));
	public static final RegistryObject<ArmorItem> DECAY_NETHERITE_LEGGINGS = combatTabEnqueue(yatmGeTabEnqueue(ITEMS.register("decaying_soul_adorned_netherite_leggings", () -> new ArmorItem(YATMArmorMaterials.DECAYING_SOUL_ADORNED_NETHERITE, ArmorItem.Type.LEGGINGS, new Item.Properties().fireResistant()))));
	public static final RegistryObject<ArmorItem> DECAY_NETHERITE_BOOTS = combatTabEnqueue(yatmGeTabEnqueue(ITEMS.register("decaying_soul_adorned_netherite_boots", () -> new ArmorItem(YATMArmorMaterials.DECAYING_SOUL_ADORNED_NETHERITE, ArmorItem.Type.BOOTS, new Item.Properties().fireResistant()))));
	
	public static final RegistryObject<BlockItem> CREATIVE_CURRENT_SOURCE_ITEM = toolTabEnqueue(yatmGeTabEnqueue(ITEMS.register("creative_current_source", () -> new BlockItem(YATMBlocks.CREATIVE_CURRENT_SOURCE.get(), new Item.Properties()))));
