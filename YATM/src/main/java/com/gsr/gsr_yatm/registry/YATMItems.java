...
public class YATMItems
{
	...
	public static final RegistryObject<BlockItem> CRYSTALLIZER = functionalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("crystallizer", () -> new BlockItem(YATMBlocks.CRYSTALLIZER.get(), new Item.Properties()))));
	public static final RegistryObject<BlockItem> HEAT_FURNACE = functionalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("heat_furnace", () -> new BlockItem(YATMBlocks.HEAT_FURNACE.get(), new Item.Properties()))));	
	public static final RegistryObject<BlockItem> EXTRACTOR = functionalTabEnqueue(yatmGeTabEnqueue(ITEMS.register("extractor", () -> new BlockItem(YATMBlocks.EXTRACTOR.get(), new Item.Properties()))));
	...
	public static final RegistryObject<CurrentStorerItem> CURRENT_TUBER = ingredientTabEnqueue(toolTabEnqueue(yatmGeTabEnqueue(ITEMS.register("current_tuber", () -> new CurrentStorerItem(new Item.Properties().durability(1).setNoRepair(), YATMConfigs.CURRENT_TUBER_CURRENT_CAPACITY)))));
	public static final RegistryObject<CurrentStorerItem> CURRENT_BATTERY = ingredientTabEnqueue(toolTabEnqueue(yatmGeTabEnqueue(ITEMS.register("current_battery", () -> new CurrentStorerItem(new Item.Properties().durability(1).setNoRepair(), YATMConfigs.CURRENT_BATTERY_CURRENT_CAPACITY)))));
	public static final RegistryObject<CurrentStorerItem> ADVANCED_CURRENT_BATTERY = ingredientTabEnqueue(toolTabEnqueue(yatmGeTabEnqueue(ITEMS.register("advanced_current_battery", () -> new CurrentStorerItem(new Item.Properties().durability(1).setNoRepair(), YATMConfigs.ADVANCED_CURRENT_BATTERY_CURRENT_CAPACITY)))));
