...
public class YATMItems
{
	...
	public static final RegistryObject<BlockItem> CUPRUM_BULB = generalTabEnqueue(ITEMS.register("cuprum_bulb", () -> new BlockItem(YATMBlocks.CUPRUM.get(), new Item.Properties().fireResistant())));
	public static final RegistryObject<BlockItem> FERRUM_ROOTSTOCK = generalTabEnqueue(ITEMS.register("ferrum_rootstock", () -> new BlockItem(YATMBlocks.FERRUM.get(), new Item.Properties().fireResistant())));
	public static final RegistryObject<BlockItem> FOLIUM_RHIZOME = generalTabEnqueue(ITEMS.register("folium_rhizome", () -> new BlockItem(YATMBlocks.FOLIUM.get(), new Item.Properties().fireResistant())));
	public static final RegistryObject<BlockItem> INFERNALUM_RHIZOME = generalTabEnqueue(ITEMS.register("infernalum_rhizome", () -> new BlockItem(YATMBlocks.INFERNALUM.get(), new Item.Properties().fireResistant())));
	public static final RegistryObject<BlockItem> LAPUM_MERISTEM = generalTabEnqueue(ITEMS.register("lapum_meristem", () -> new BlockItem(YATMBlocks.LAPUM.get(), new Item.Properties().fireResistant())));
	public static final RegistryObject<BlockItem> RUBERUM_CORM = generalTabEnqueue(ITEMS.register("ruberum_corm", () -> new BlockItem(YATMBlocks.RUBERUM.get(), new Item.Properties().fireResistant())));
	public static final RegistryObject<BlockItem> SAMARAGDUM_NODULE = generalTabEnqueue(ITEMS.register("samaragdum_nodule", () -> new BlockItem(YATMBlocks.SAMARAGDUM.get(), new Item.Properties().fireResistant())));
	public static final RegistryObject<BlockItem> VICUM_MERISTEM = generalTabEnqueue(ITEMS.register("vicum_meristem", () -> new BlockItem(YATMBlocks.VICUM.get(), new Item.Properties())));
	...
	public static final RegistryObject<BlockItem> FIRE_EATER_LILY_DECORATIVE = generalTabEnqueue(ITEMS.register("fire_eater_lily_decorative", () -> new BlockItem(YATMBlocks.FIRE_EATER_LILY_DECORATIVE.get(), new Item.Properties())));
	public static final RegistryObject<BlockItem> FIRE_EATER_LILY_UNLIT_DECORATIVE = generalTabEnqueue(ITEMS.register("fire_eater_lily_unlit_decorative", () -> new BlockItem(YATMBlocks.FIRE_EATER_LILY_UNLIT_DECORATIVE.get(), new Item.Properties())));
...
//	public static final RegistryObject<BlockItem> STEEL_EXTRUDER_ITEM = /* generalTabEnqueue */(ITEMS.register("steel_extruder", () -> new BlockItem(YATMBlocks.STEEL_EXTRUDER.get(), new Item.Properties())));
	...
	public static final RegistryObject<Item> NETHERITE_NUGGET = generalTabEnqueue(ITEMS.register("netherite_nugget", () -> new Item(new Item.Properties())));public static final RegistryObject<Item> STAR_SEED = generalTabEnqueue(ITEMS.register("star_seed", () -> new Item(new Item.Properties())));
