...
public class YATMConfigs
{
	...
	public static final ConfigValue<Integer> BOILER_FILL_INPUT_MAX_FLUID_TRANSFER_RATE = YATMConfigs.s_builder.comment("The most fluid that can be moved per tick while filling up it's input tank.").defineInRange("fill_input_max_fluid_transfer_rate", YATMConfigs.STEEL_DEVICE_MAX_FLUID_TRANSFER_RATE, 0, Integer.MAX_VALUE);
	...
	public static final ConfigValue<Integer> EXTRACTOR_CURRENT_CAPACITY = YATMConfigs.s_builder.pop().push("Extractor: ").comment("The maximum number of cu the device can hold.").defineInRange("current_capacity", YATMConfigs.STEEL_DEVICE_CURRENT_CAPACITY, 0, Integer.MAX_VALUE);
	public static final ConfigValue<Integer> EXTRACTOR_DRAIN_RESULT_MAX_FLUID_TRANSFER_RATE = YATMConfigs.s_builder.comment("The most fluid that can be moved per tick while draining out it's result tank.").defineInRange("drain_result_max_fluid_transfer_rate", YATMConfigs.STEEL_DEVICE_MAX_FLUID_TRANSFER_RATE, 0, Integer.MAX_VALUE);
	public static final ConfigValue<Integer> EXTRACTOR_DRAIN_RESULT_RECHECK_PERIOD = YATMConfigs.s_builder.comment("The period in ticks of the device trying to reattach a slotted result tank draining component to relavent neighbors.").defineInRange("drain_result_recheck_period", YATMConfigs.DRAIN_RECHECK_PERIOD, 0, Integer.MAX_VALUE);
	public static final ConfigValue<Integer> EXTRACTOR_MAX_CURRENT_TRANSFER = YATMConfigs.s_builder.comment("The most current that can be moved per tick.").defineInRange("max_current_transfer_rate", YATMConfigs.STEEL_DEVICE_MAX_CURRENT_TRANSFER_RATE, 0, Integer.MAX_VALUE);
	public static final ConfigValue<Integer> EXTRACTOR_RESULT_TANK_CAPACITY = YATMConfigs.s_builder.comment("The result tank's fluid capacity.").defineInRange("result_tank_capacity", YATMConfigs.STEEL_DEVICE_TANK_CAPACITY, 0, Integer.MAX_VALUE);
	...
	public static final ConfigValue<Integer> HEAT_FURNACE_MAX_TEMPERATURE = YATMConfigs.s_builder.pop().push("Heat Furnace: ").comment("The highest possible temperature for the device.").defineInRange("max_temperature", YATMConfigs.STEEL_DEVICE_MAX_TEMPERATURE, 0, Integer.MAX_VALUE);
	
	public static final ConfigValue<Integer> INJECTOR_CURRENT_CAPACITY = YATMConfigs.s_builder.pop().push("Injector: ").comment("The maximum number of cu the device can hold.").defineInRange("current_capacity", YATMConfigs.STEEL_DEVICE_CURRENT_CAPACITY, 0, Integer.MAX_VALUE);
	public static final ConfigValue<Integer> INJECTOR_DRAIN_INPUT_MAX_FLUID_TRANSFER_RATE = YATMConfigs.s_builder.comment("The most fluid that can be moved per tick while draining out it's input tank.").defineInRange("drain_input_max_fluid_transfer_rate", YATMConfigs.STEEL_DEVICE_MAX_FLUID_TRANSFER_RATE, 0, Integer.MAX_VALUE);
	public static final ConfigValue<Integer> INJECTOR_DRAIN_INPUT_RECHECK_PERIOD = YATMConfigs.s_builder.comment("The period in ticks of the device trying to reattach a slotted input tank draining component to relavent neighbors.").defineInRange("drain_recheck_period", YATMConfigs.DRAIN_RECHECK_PERIOD, 0, Integer.MAX_VALUE);
	public static final ConfigValue<Integer> INJECTOR_FILL_INPUT_MAX_FLUID_TRANSFER_RATE = YATMConfigs.s_builder.comment("The most fluid that can be moved per tick while filling.").defineInRange("fill_input_max_fluid_transfer_rate", YATMConfigs.STEEL_DEVICE_MAX_FLUID_TRANSFER_RATE, 0, Integer.MAX_VALUE);
	public static final ConfigValue<Integer> INJECTOR_INPUT_TANK_CAPACITY = YATMConfigs.s_builder.comment("The input tank's fluid capacity.").defineInRange("input_tank_capacity", YATMConfigs.STEEL_DEVICE_TANK_CAPACITY, 0, Integer.MAX_VALUE);
	public static final ConfigValue<Integer> INJECTOR_MAX_CURRENT_TRANSFER = YATMConfigs.s_builder.comment("The most current that can be moved per tick.").defineInRange("max_current_transfer_rate", YATMConfigs.STEEL_DEVICE_MAX_CURRENT_TRANSFER_RATE, 0, Integer.MAX_VALUE);
	...
	public static final ConfigValue<Integer> STILL_DRAIN_INPUT_MAX_FLUID_TRANSFER_RATE = YATMConfigs.s_builder.comment("The most fluid that can be moved per tick while draining out it's input tank.").defineInRange("drain_input_max_fluid_transfer_rate", YATMConfigs.STEEL_DEVICE_MAX_FLUID_TRANSFER_RATE, 0, Integer.MAX_VALUE);
	public static final ConfigValue<Integer> STILL_DRAIN_INPUT_RECHECK_PERIOD = YATMConfigs.s_builder.comment("The period in ticks of the device trying to reattach a slotted input tank draining component to relavent neighbors.").defineInRange("drain_input_recheck_period", YATMConfigs.DRAIN_RECHECK_PERIOD, 0, Integer.MAX_VALUE);
	public static final ConfigValue<Integer> STILL_DRAIN_REMAINDER_MAX_FLUID_TRANSFER_RATE = YATMConfigs.s_builder.comment("The most fluid that can be moved per tick while draining out it's remainder tank.").defineInRange("drain_remainder_max_fluid_transfer_rate", YATMConfigs.STEEL_DEVICE_MAX_FLUID_TRANSFER_RATE, 0, Integer.MAX_VALUE);
	public static final ConfigValue<Integer> STILL_DRAIN_REMAINDER_RECHECK_PERIOD = YATMConfigs.s_builder.comment("The period in ticks of the device trying to reattach a slotted remainder tank draining component to relavent neighbors.").defineInRange("drain_remainder_recheck_period", YATMConfigs.DRAIN_RECHECK_PERIOD, 0, Integer.MAX_VALUE);
	public static final ConfigValue<Integer> STILL_FILL_INPUT_MAX_FLUID_TRANSFER_RATE = YATMConfigs.s_builder.comment("The most fluid that can be moved per tick while filling up it's input tank.").defineInRange("fill_input_max_fluid_transfer_rate", YATMConfigs.STEEL_DEVICE_MAX_FLUID_TRANSFER_RATE, 0, Integer.MAX_VALUE);
