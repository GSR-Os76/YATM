...
public class YATMConfigs
{
	...
	private static final int DEFAULT_CURRENT_TUBER_CURRENT_CAPACITY = 32768;
	...
	public static final ConfigValue<Integer> FIRE_EATER_LILY_GROWTH_RARITY = YATMConfigs.s_builder.comment("This value divided by the heat level is the average number of random ticks for which the plant increases in age one time.").defineInRange("growth_rarity", 156, 0, Integer.MAX_VALUE);
	...
	public static final Supplier<SolarPanelSettings> ADVANCED_SOLAR_PANEL_SETTINGS = YATMConfigs.s_builder.pop().push("Advanced: ").solarPanelSettings(YATMConfigs.DRAIN_RECHECK_PERIOD, YATMConfigs.DEFAULT_CURRENT_BATTERY_CURRENT_CAPACITY / YATMConfigs.CURRENT_STORER_BLOCK_CURRENT_CAPACITY_TO_TRANSFER_SIZE_FACTOR, YATMConfigs.DEFAULT_CURRENT_BATTERY_CURRENT_CAPACITY * 3, 32, 0.0f, 1.0f, 0.0f, 0.5f);
	public static final Supplier<SolarPanelSettings> SUNS_COMPLEMENT_SOLAR_PANEL_SETTINGS = YATMConfigs.s_builder.pop().push("Suns Complement: ").solarPanelSettings(YATMConfigs.DRAIN_RECHECK_PERIOD, YATMConfigs.DEFAULT_ADVANCED_CURRENT_BATTERY_CURRENT_CAPACITY / YATMConfigs.CURRENT_STORER_BLOCK_CURRENT_CAPACITY_TO_TRANSFER_SIZE_FACTOR, YATMConfigs.DEFAULT_ADVANCED_CURRENT_BATTERY_CURRENT_CAPACITY * 3, 192, 0.0f, 1.0f, 0.125f, 0.875f);
	...
	public static final ConfigValue<Integer> CURRENT_TUBER_CURRENT_CAPACITY = YATMConfigs.s_builder.pop().pop().push("Current Storers: ").push("Current Tuber: ").currentCapacity(YATMConfigs.DEFAULT_CURRENT_TUBER_CURRENT_CAPACITY);
	public static final ConfigValue<Integer> CURRENT_BATTERY_CURRENT_CAPACITY = YATMConfigs.s_builder.pop().push("Current Battery: ").currentCapacity(YATMConfigs.DEFAULT_CURRENT_BATTERY_CURRENT_CAPACITY);
	public static final ConfigValue<Integer> ADVANCED_CURRENT_BATTERY_CURRENT_CAPACITY = YATMConfigs.s_builder.pop().push("Advanced Current Battery: ").currentCapacity(YATMConfigs.DEFAULT_ADVANCED_CURRENT_BATTERY_CURRENT_CAPACITY);
