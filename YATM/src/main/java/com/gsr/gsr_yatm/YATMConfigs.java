...
public class YATMConfigs
{
	...
	public static final ConfigValue<Double> FOLIAR_STEEL_NETHERITE_RELATIVE_DEFENSE_FACTOR = YATMConfigs.s_builder.pop().push("Foliar Steel: ").comment("The proportion of defence the armor pieces have relative to the corresponding Netherite armor piece.").defineInRange("netherite_relative_defense_factor", 0.9d, Double.MIN_VALUE, Double.MAX_VALUE);
	public static final ConfigValue<Double> FOLIAR_STEEL_NETHERITE_RELATIVE_DURABILITY_FACTOR = YATMConfigs.s_builder.comment("The proportion of durability the armor pieces have relative to the corresponding Netherite armor piece.").defineInRange("netherite_relative_durability_factor", 0.9d, Double.MIN_VALUE, Double.MAX_VALUE);
	public static final ConfigValue<Double> FOLIAR_STEEL_NETHERITE_RELATIVE_ENCHANTMENT_FACTOR = YATMConfigs.s_builder.comment("The proportion of unchantability the armor has relative to Netherite armor.").defineInRange("netherite_relative_enchantment_factor", 0.9d, Double.MIN_VALUE, Double.MAX_VALUE);
	public static final ConfigValue<Double> FOLIAR_STEEL_NETHERITE_RELATIVE_KNOCKBACK_RESISTANCE_FACTOR = YATMConfigs.s_builder.comment("The proportion of knockback resistance which the armor has relative to Netherite armor.").defineInRange("netherite_relative_knockback_resistance_factor", 0.9d, Double.MIN_VALUE, Double.MAX_VALUE);
	public static final ConfigValue<Double> FOLIAR_STEEL_NETHERITE_RELATIVE_TOUGHNESS_FACTOR = YATMConfigs.s_builder.comment("The proportion of toughness the armor has relative to Netherite armor.").defineInRange("netherite_relative_toughness_factor", 0.9d, Double.MIN_VALUE, Double.MAX_VALUE);
